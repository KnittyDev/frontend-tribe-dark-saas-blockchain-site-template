...
const cardData = [{
    ...
    description:'Effortessly integrate and manage blockchain data with our cutting-edge API, designed for seamless connectivity.',
    color:'fuchsia'
    },
    {
    image:'/assets/images/cuboid.png',
    title:'Decentralized Data Solutions',
    description:'Empower your applications with decentralized data solutions, ensuring,s security and transparency at every step.',
    color:'lime'
    },
    {
    image:'/assets/images/cone.png',
    title:'Next-Gen Smart Contracts',
    description:'Unlock the potential of next-gen smart contracts with our robust and scalable API, tailored for modern blockchains needs',
    color:'cyan'
    },
    {
    image:'/assets/images/icosahedron.png',
    title:'Seamless Blockchain Integration',
    description:'Ingrate blockchain technology seamlessy into your projects, with minimal effort and maximum effecieny.',
    color:'violet'
    }];
            ...
            <div className="mt-36 lg:mt-48 flex">
                ...
                {cardData.map(({ image, title, description, color}) => (
                    ...
                    color === "violet" && "bg-violet-500 group-hover:bg-violet-400",
                        ...
                        <div className="absolute h-4 w-full top-[calc(100%+16px)]
                        bg-zinc-950/70 group-hover:bg-zinc-950/30 transition duration-300 rounded-[100%] [mask-image:radial-gradient(closest-side,black,transparent)]"></div>
                        <img 
                        src={image} 
                        alt="Pill image" 
